...
public class IteratorPublisher2<T> implements Flow.Publisher<T> {

    private static final Logger logger = LoggerFactory.getLogger(IteratorPublisher2.class);

    private final Supplier<Iterator<? extends T>> iteratorSupplier;

    public IteratorPublisher2(Supplier<Iterator<? extends T>> iteratorSupplier) {
