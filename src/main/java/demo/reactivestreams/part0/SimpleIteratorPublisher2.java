...
public class SimpleIteratorPublisher2 implements Flow.Publisher<Integer> {

    private static final Logger logger = LoggerFactory.getLogger(SimpleIteratorPublisher2.class);

    private final Iterator<Integer> iterator;

    public SimpleIteratorPublisher2(Iterator<Integer> iterator) {
